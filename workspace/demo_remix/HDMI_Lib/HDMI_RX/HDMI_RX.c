...
0x02,0x03,0x3F,0x71, 0x4F,0x85,0x02,0x03, 0x04,0x01,0x06,0x07, 0x11,0x12,0x13,0x14,
0x15,0x16,0x0F,0x1E, 0X3E,0x09,0x07,0x07, 0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00,
0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00,
0x00,0x00,0x00,0x83, 0x01,0x00,0x00,0x67, 0x03,0x0C,0x00,0x00, 0x00,0x00,0x2D,0x01,
0x1D,0x80,0xD0,0x72, 0x1C,0x16,0x20,0x10, 0x2C,0x25,0x80,0x5B, 0x56,0x21,0x00,0x00,
0x9E,0x8C,0x0A,0xD0, 0x90,0x20,0x40,0x31, 0x20,0x0C,0x40,0x55, 0x00,0xC4,0x8E,0x21,
0x00,0x00,0x18,0x01, 0x1D,0x00,0x72,0x51, 0xD0,0x1E,0x20,0x6E, 0x28,0x55,0x00,0x5B,
0x56,0x21,0x00,0x00, 0x1E,0x00,0x00,0x00, 0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x53  
};
...
void EDID_WriteProtect(bool bEnable){
    IOWR(HDMI_RX_EDID_WP_BASE, 0, bEnable?0x01:0x00); // high: write protetion
}

void HDMIRX_EnableEdid(void){
    // set eeprom i2c pin as input pin to FPGA, so source can read EDID.
    I2C_Close(HDMI_RX0_EP_SCL_BASE, HDMI_RX0_EP_SDA_BASE);
    I2C_Close(HDMI_RX1_EP_SCL_BASE, HDMI_RX1_EP_SDA_BASE);
}
...
bool HDMIRX_WriteEeprom(RX_EEPROM_TYPE EepromType){
    ...
    if (EepromType == RX0_EEPROM)    
        I2C_Open(HDMI_RX0_EP_SCL_BASE, HDMI_RX0_EP_SDA_BASE);
    else        
        I2C_Open(HDMI_RX1_EP_SCL_BASE, HDMI_RX1_EP_SDA_BASE);
...
//        bChangeMode = TRUE;   TRUE=NOVIDEO FALSE=VIDEOOK
