...
#
# Generated: 2013-07-05 01:46:50.429
...
QUARTUS_PROJECT_DIR = /root/LPM

# the simulation directory is a subdirectory of the PTF directory
SIMDIR = $(QUARTUS_PROJECT_DIR)/DE3_SOPC_sim
...
$(QUARTUS_PROJECT_DIR)/onchip_mem.hex: $(ELF)
	...
	elf2hex $(ELF) 0x01020000 0x103FFFF --width=32 $(QUARTUS_PROJECT_DIR)/onchip_mem.hex --create-lanes=0
...
dummy_verifysysid_file:
	nios2-download $(JTAG_CABLE)                                --sidp=0x00000170 --id=0 --timestamp=1299203513
